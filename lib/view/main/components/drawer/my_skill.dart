  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        ...
        AnimatedLinearProgressIndicator(percentage: 0.9, title: 'Api-integration',image: 'assets/icons/dart.png'),
        ...
        AnimatedLinearProgressIndicator(percentage: 0.74, title: 'provider',image: 'assets/icons/bloc.png'),
        AnimatedLinearProgressIndicator(percentage: 0.90, title: 'Third parties librars',image: 'assets/icons/dart.png'),
        AnimatedLinearProgressIndicator(percentage: 0.95, title: 'Git-hub',image: 'assets/icons/dart.png'),
        AnimatedLinearProgressIndicator(percentage: 0.76, title: 'Problem Solving',image: 'assets/icons/dart.png'),
        AnimatedLinearProgressIndicator(percentage: 0.38, title: 'Laravel-Backhand',image: 'assets/icons/dart.png'),
